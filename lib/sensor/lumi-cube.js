...
const { Controller } = require('appliances/controller');

const SIDES = [ 'side-one', 'side-two', 'side-three', 'side-four', 'side-five', 'side-six' ];
module.exports.Main = class CubeMain extends Controller.with(Sensor) {
	static get type() {
...
module.exports.Rotation = class CubeRotation extends Controller.with(Sensor) {
	static get type() {
