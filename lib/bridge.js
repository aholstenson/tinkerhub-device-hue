...
const { Appliance, State, Children, Storage, Nameable } = require('appliances');
...
module.exports = class Bridge extends Appliance.with(State, Storage, Children, Nameable) {
	static get type() {
		return 'hue:bridge';
	}
